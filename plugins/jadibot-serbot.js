...
// Verificar si es un bot VIP
const botNumber = path.basename(pathYukiJadiBot).replace(/[^0-9]/g, '')
const isVipBot = global.premiumSubBots?.includes(botNumber)
const botType = isVipBot ? '💎 VIP' : '🆓 FREE'

console.log(chalk.bold.cyanBright(`\n❒⸺⸺⸺⸺【• SUB-BOT ${botType} •】⸺⸺⸺⸺❒\n│\n│ 🟢 ${userName} (+${path.basename(pathYukiJadiBot)}) conectado exitosamente.\n│ ${isVipBot ? '💎 Modo: Premium VIP' : '🆓 Modo: Gratuito'}\n│ ${isVipBot ? '🔄 Auto-reconexión: ACTIVADA' : '⚠️ Auto-reconexión: DESACTIVADA'}\n│\n❒⸺⸺⸺【• CONECTADO •】⸺⸺⸺❒`))

sock.isInit = true
sock.isVip = isVipBot

// Activar auto-reconexión solo para bots VIP
if (isVipBot) {
